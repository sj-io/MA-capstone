...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.56}}
  >{\centering\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.12}}
  >{\centering\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.08}}
  >{\centering\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.04}}
  >{\centering\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.12}}
  >{\centering\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.08}}@{}}
...
\includegraphics{MA-capstone_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{MA-capstone_files/figure-latex/unnamed-chunk-14-1.pdf}
