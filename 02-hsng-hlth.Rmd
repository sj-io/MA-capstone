...
>
> [Washington Post](https://www.washingtonpost.com/nation/interactive/2021/eviction-moratorium-lifts/) subheadline, June 28, 2021
...
One worrying outcome is a simultaneous great need from citizens for housing assistance and a large pool of public funds available specifically for housing, but inefficient systems that deny the two should ever meet. Indeed, this is already a reality in other cities that have not been able to connect

Once a tenant has been evicted, their options for new housing are limited. Eviction records are publicly available through county courts, and simply having an eviction on your record can deny you housing.

turn ESP funds into housing vouchers?
