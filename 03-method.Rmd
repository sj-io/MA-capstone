...
`FOLLOWUP_DATE` is confusing and used inconsistently. Sometimes the field is NA, other times it is set for 1900-01-01. For some entries it is obvious from other fields of an update that is not listed.
...
There are also obvious **privacy issues** included in the field, such as the full name and phone numbers of individuals.
