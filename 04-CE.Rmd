...
library(DT)
tntmv_tbl <- tntmv %>% select(sr, RESOLUTION_SUMMARY, everything())
datatable(tntmv_tbl)
```

SR: 4569338 "per: tenant jessica they moved due to respiratory problems from the mold/mildew like substance"
